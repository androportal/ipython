...
class MappingKernelManager(MultiKernelManager):
    ...
    time_to_dead = Float(15.0, config=True, help="""Kernel heartbeat interval in seconds.""")
    first_beat = Float(10.0, config=True, help="Delay (in seconds) before sending first heartbeat.")
